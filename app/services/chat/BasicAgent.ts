...
import { ChainValues, BaseMessage } from 'langchain/schema';


export default class BasicAgentRunner<T extends BaseMessage> {
  constructor(private agentExecutor: AgentExecutor, private chatHistory: T[]){}
...
export async function getFunctionsAgentExecutor(
  ...
  try {
      ...
      err(`error creating agent executor in 'getFunctionsAgent' ${e}`);
      throw e;
  }
}
/**
